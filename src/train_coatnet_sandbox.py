...
def train_coatnet():
    print("Initializing CoAtNet-0 Sandbox...")
    ...
    for epoch in range(epochs):
        ...
        print(f"CoAtNet Epoch [{epoch+1}/{epochs}] Loss: {running_loss/len(train_loader):.4f}")
        
    os.makedirs("models/sandbox", exist_ok=True)
    torch.save(model.state_dict(), "models/sandbox/coatnet_baseline.pth")
    print("CoAtNet Training Complete. Saved to models/sandbox/coatnet_baseline.pth")
